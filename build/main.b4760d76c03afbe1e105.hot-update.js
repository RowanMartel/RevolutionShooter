...
class Enemy {
    ...
    move() {
        ...
        if (Math.sqrt(Math.pow(this.targetY - this.sprite.y, 2) + Math.pow(this.targetX - this.sprite.x, 2)) < this.speed * 3)
            return;
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("dbab66557b0d56e1d7f0")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.b4760d76c03afbe1e105.hot-update.js.map