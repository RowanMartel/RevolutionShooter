...
class Enemy {
    ...
    move() {
        ...
        if (Math.sqrt(Math.pow(this.targetY - this.sprite.y, 2) + Math.pow(this.targetX - this.sprite.x, 2)) < this.speed * 10)
            return;
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("000574e8272644098a23")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.b6be954f2dd0bb21880f.hot-update.js.map