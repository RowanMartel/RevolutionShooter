...
const Buttons_1 = __webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module './Buttons'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
let stage;
let canvas;
let assetManager;
let background;
...
function onReady(e) {
    ...
    buttons = new Buttons_1.Buttons(assetManager, stage);
    score.goToFront();
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("062f3a84c78dfc1bbf53")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.2e873369b210e49beb09.hot-update.js.map