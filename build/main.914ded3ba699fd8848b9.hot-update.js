...
class Bullet {
    ...
    fire() {
        this.sprite.x = this.enemy.Sprite.x;
        this.sprite.y = this.enemy.Sprite.y;
        this.angle = Math.atan2(this.player.Sprite.y + 25 - this.sprite.y, this.player.Sprite.x + 15 - this.sprite.x);
        this.active = true;
        this.sprite.x = this.enemy.Sprite.x;
        this.sprite.y = this.enemy.Sprite.y;
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("c499f8656802cc8f0ee5")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.914ded3ba699fd8848b9.hot-update.js.map