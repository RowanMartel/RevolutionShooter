...
class Player {
    ...
    clampPos() {
        if (this.sprite.x < -10)
            this.sprite.x = -10;
        else if (this.sprite.x > Constants_1.STAGE_WIDTH - 25)
            this.sprite.x = Constants_1.STAGE_WIDTH - 25;
        if (this.sprite.y < 0)
            this.sprite.y = 0;
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("3106be3f49abe9f07a5a")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.2e3eb79eb5f7b73ba57d.hot-update.js.map