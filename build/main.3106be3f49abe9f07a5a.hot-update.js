...
class Player {
    ...
    clampPos() {
        if (this.sprite.x < -10)
            this.sprite.x = -10;
        else if (this.sprite.x > Constants_1.STAGE_WIDTH - 30)
            this.sprite.x = Constants_1.STAGE_WIDTH - 30;
        if (this.sprite.y < 0)
            this.sprite.y = 0;
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("4a1e9bd64728feeaf8d3")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.3106be3f49abe9f07a5a.hot-update.js.map