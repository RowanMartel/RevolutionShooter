...
class Player {
    ...
    clampPos() {
        if (this.sprite.x < 0)
            ...
            this.sprite.x = Constants_1.STAGE_WIDTH - this.sprite.getBounds().x;
        if (this.sprite.y < 0)
            this.sprite.y = 0;
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("1203b6cce032249dbdad")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.5625f3ea3e4f18d61c94.hot-update.js.map