...
class Player {
    ...
    clampPos() {
        if (this.sprite.x < -10)
            ...
            this.sprite.x = Constants_1.STAGE_WIDTH;
        if (this.sprite.y < 0)
            this.sprite.y = 0;
        else if (this.sprite.y > Constants_1.STAGE_HEIGHT)
            this.sprite.y = Constants_1.STAGE_HEIGHT;
    }
    fire() {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("9b1e4c4cb7eb552261cc")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.886a3e61a0e56664db0c.hot-update.js.map