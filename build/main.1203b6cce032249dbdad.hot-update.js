...
class Player {
    ...
    clampPos() {
        ...
        if (this.sprite.y < 0)
            this.sprite.y = 0;
        else if (this.sprite.y > Constants_1.STAGE_HEIGHT - this.sprite.getBounds().y)
            this.sprite.y = Constants_1.STAGE_HEIGHT - this.sprite.getBounds().y;
    }
}
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("3a4c94215f96527fc49e")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.1203b6cce032249dbdad.hot-update.js.map