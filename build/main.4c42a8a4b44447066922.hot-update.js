...
class Player {
    ...
    damage() {
        if (this.inIFrames)
            return;
        this.lives--;
        this.lifeMarkers[this.lifeMarkers.length - 1].visible = false;
        if (this.lives == 0)
            this.gameOver();
        this.enterIFrames();
    }
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("4003d486bafb9c2fa2c5")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.4c42a8a4b44447066922.hot-update.js.map