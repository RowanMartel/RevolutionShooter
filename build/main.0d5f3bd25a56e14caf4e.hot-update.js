...
class Enemy {
    ...
    attack() {
        if (!this.bullet.Active) {
            this.bullet.fire();
            this.sprite.gotoAndStop("Enemies/" + this.firingSprite);
        }
        else
            this.sprite.gotoAndStop("Enemies/" + this.idleSprite);
    }
    get Sprite() {
        return this.sprite;
    }
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("04c841c46c4a8fe210bd")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.0d5f3bd25a56e14caf4e.hot-update.js.map