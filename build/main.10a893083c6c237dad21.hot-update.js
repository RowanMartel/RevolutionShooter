...
class Enemy {
    ...
    getRandomY() {
        ...
        do {
            ...
            if (y < 10)
                y = 10;
        } while (y > Constants_1.STAGE_HEIGHT / 3 && y < Constants_1.STAGE_HEIGHT / 5);
        return y;
    }
    update() {
        if (!this.active)
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("1a05589d6b62907fa03d")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.10a893083c6c237dad21.hot-update.js.map