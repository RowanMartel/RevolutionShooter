...
class Player {
    ...
    clampPos() {
        if (this.sprite.x < 0)
            this.sprite.x = 0;
        else if (this.sprite.x > Constants_1.STAGE_WIDTH - this.sprite.getBounds().x * 10)
            this.sprite.x = Constants_1.STAGE_WIDTH - this.sprite.getBounds().x * 10;
        if (this.sprite.y < 0)
            this.sprite.y = 0;
        else if (this.sprite.y > Constants_1.STAGE_HEIGHT - this.sprite.getBounds().y * 100)
            this.sprite.y = Constants_1.STAGE_HEIGHT - this.sprite.getBounds().y * 100;
    }
}
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("7313bcf24fdf3f9a3059")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.f318f940febac9da0d09.hot-update.js.map