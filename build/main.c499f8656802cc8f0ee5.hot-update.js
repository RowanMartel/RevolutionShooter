...
class Bullet {
    ...
    fire() {
        this.sprite.x = this.enemy.Sprite.x;
        this.sprite.y = this.enemy.Sprite.y;
        this.angle = Math.atan2(this.player.Sprite.y + 50 - this.sprite.y, this.player.Sprite.x + 25 - this.sprite.x);
        this.active = true;
        this.sprite.x = this.enemy.Sprite.x;
        this.sprite.y = this.enemy.Sprite.y;
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("c35709ebd30c4b93eb46")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.c499f8656802cc8f0ee5.hot-update.js.map