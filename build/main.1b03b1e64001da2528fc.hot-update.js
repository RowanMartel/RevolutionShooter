...
class Player {
    ...
    reset() {
        ...
        for (let index = 0; index < Constants_1.MAX_AMMO; index++)
            this.heads.push(new Head_1.Head(this.stage, this.assetManager, this, this.enemyManager));
        this.lifeMarkers = [];
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("ce51cda91bd9f39c5f16")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.1b03b1e64001da2528fc.hot-update.js.map