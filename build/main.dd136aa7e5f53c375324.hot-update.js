...
class EnemyManager {
    ...
    determineEnemy() {
        switch (this.score.KillCount) {
            ...
            case 3:
            case 4:
                return new BasicEnemy_1.BasicEnemy(this.assetManager, this.stage);
                break;
            default:
                return new BasicEnemy_1.BasicEnemy(this.assetManager, this.stage);
        }
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("eed7b73a53926c53425b")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.dd136aa7e5f53c375324.hot-update.js.map