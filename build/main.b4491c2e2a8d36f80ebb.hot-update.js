...
class Player {
    ...
    clampPos() {
        if (this.sprite.x < 0)
            this.sprite.x = 0;
        else if (this.sprite.x > Constants_1.STAGE_WIDTH - this.sprite.getTransformedBounds().x)
            this.sprite.x = Constants_1.STAGE_WIDTH - this.sprite.getTransformedBounds().x;
        if (this.sprite.y < 0)
            this.sprite.y = 0;
        else if (this.sprite.y > Constants_1.STAGE_HEIGHT - this.sprite.getTransformedBounds().y)
            this.sprite.y = Constants_1.STAGE_HEIGHT - this.sprite.getTransformedBounds().y;
    }
}
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("198d0c133a8dc9cb3986")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.b4491c2e2a8d36f80ebb.hot-update.js.map