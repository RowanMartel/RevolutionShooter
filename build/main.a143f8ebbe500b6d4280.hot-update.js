...
class Enemy {
    ...
    move() {
        if (this.sprite.x == this.targetX && this.sprite.y == this.targetY)
            return;
        this.angle = Math.atan2(this.targetY - this.sprite.y, this.targetX - this.sprite.x) * 180 / Math.PI + 90;
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("0cd90b9cbace18201715")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.a143f8ebbe500b6d4280.hot-update.js.map