...
class Enemy {
    ...
    move() {
        ...
        if (Math.sqrt(Math.pow(this.targetY - this.sprite.y, 2) + Math.pow(this.targetX - this.sprite.x, 2)) < this.speed * 4)
            return;
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("b6be954f2dd0bb21880f")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.dbab66557b0d56e1d7f0.hot-update.js.map