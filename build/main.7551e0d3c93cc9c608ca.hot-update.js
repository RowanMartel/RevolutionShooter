...
class Player {
    constructor(stage, assetManager, inputManager) {
        ...
        this.hitBox.scaleX = 3;
        this.hitBox.scaleY = 3;
    ...
    hitboxMove() {
        this.hitBox.x = this.sprite.x + 26;
        this.hitBox.y = this.sprite.y + 15;
    }
    isHit() {
        let bullets = this.enemyManager.getBullets();
        for (let index = 0; index < bullets.length; index++) {
            if ((0, Toolkit_1.radiusHit)(this.sprite, 20, bullets[index].Sprite, 1))
                return true;
        }
        return false;
    }
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("729abb552819334f105a")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.7551e0d3c93cc9c608ca.hot-update.js.map