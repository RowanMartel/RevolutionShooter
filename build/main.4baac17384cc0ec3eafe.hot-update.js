...
class EnemyManager {
    ...
    spawnEnemy() {
        console.log(this.score.KillCount);
        if ((0, Toolkit_1.randomMe)(1, 200) > 100 - (this.score.KillCount / 10 + 1)) {
            for (let index = 0; index < this.enemies.length; index++) {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("9af62fe407fe4f448e0a")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.4baac17384cc0ec3eafe.hot-update.js.map