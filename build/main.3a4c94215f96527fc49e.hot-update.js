...
class Player {
    ...
    clampPos() {
        ...
        if (this.sprite.y < 0)
            this.sprite.y = 0;
        else if (this.sprite.y > Constants_1.STAGE_HEIGHT - this.sprite.getBounds().y * 10)
            this.sprite.y = Constants_1.STAGE_HEIGHT - this.sprite.getBounds().y * 10;
    }
}
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("f318f940febac9da0d09")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.3a4c94215f96527fc49e.hot-update.js.map