...
class Enemy {
    ...
    move() {
        ...
        if (Math.sqrt(Math.pow(this.targetY - this.sprite.y, 2) + Math.pow(this.targetX - this.sprite.x, 2)) < this.speed * 2)
            return;
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("b4760d76c03afbe1e105")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.fda936d09acf7ed21a09.hot-update.js.map